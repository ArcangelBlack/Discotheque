...
namespace D.Models
{
    public class DatabaseInitializer : IDatabaseInitializer
    {
        ...
        private readonly Core.IAccountManager _accountManager;
        private readonly ILogger _logger;

        public DatabaseInitializer(ApplicationDbContext context, Core.IAccountManager accountManager, ILogger<DatabaseInitializer> logger)
        {
